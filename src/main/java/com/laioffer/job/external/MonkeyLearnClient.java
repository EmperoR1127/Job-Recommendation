...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "b01ddc686dc5e9bb7ecfd378a51bb4e10c771a65";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        try {
            // put the json body into the http request.
            request.setEntity(new StringEntity(jsonBody));
        } catch (UnsupportedEncodingException e) {
            return Collections.emptyList();
        }

        // create a response handler for the server response.
    ...
    public static void main(String[] args) {
        ...
        List<Set<String>> keywords = client.extract(articles);
